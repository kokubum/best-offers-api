...
export class initialMigrations1654961354898 implements MigrationInterface {
    name = 'initialMigrations1654961354898'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "shared_product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "stablishment_name" character varying NOT NULL, "user_id" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "product_id" uuid NOT NULL, CONSTRAINT "REL_0a62cdfa7abdfe50d78e123eaa" UNIQUE ("product_id"), CONSTRAINT "PK_4eaa2ad78ad4ce370f06312be54" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "product_of_interest" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "start_price" integer NOT NULL, "end_price" integer NOT NULL, "activate_for_third_users" boolean NOT NULL DEFAULT false, "alert" boolean NOT NULL DEFAULT false, "user_id" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "product_id" uuid NOT NULL, CONSTRAINT "PK_10400fa5068d3268f2dcbd56b0b" PRIMARY KEY ("id"))`);
